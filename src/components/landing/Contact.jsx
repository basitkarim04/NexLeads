...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="px-5 md:px-10 py-16 sm:py-20 lg:py-24 text-white"
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center min-w-0">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-[#C1E8FF] mb-6">
          ...
          <motion.img
            ...
            animate={inView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
            transition={{ duration: 0.8, delay: 0.3 }}
            className="w-full max-w-[500px] mt-2 md:-mt-12"
          ...
          <motion.div
            ...
            className="mt-6"
          >
            <p className="text-sm sm:text-base font-bold mb-3">Follow Us</p>
        ...
        <motion.div
          ...
          animate={inView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.4 }}
          className="bg-[#021024b4] p-6 md:p-8 rounded-2xl w-full md:w-[100%] md:ml-10 min-w-0"
        >
          <form onSubmit={handleSubmit}>
            {/* Status Message */}
            {status.message && (
              <div
                className={`mb-4 p-4 rounded-md text-sm sm:text-base ${
                  status.type === "success"
                    ? "bg-green-100 text-green-800 border border-green-300"
                    : "bg-red-100 text-red-800 border border-red-300"
                }`}
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-5">
              <div className="flex-1 min-w-0 flex flex-col">
                ...
                <input
                  ...
                  placeholder="John Doe"
                  required
                  className="w-full p-3 bg-white text-black rounded-md text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#8eaee0]"
                />
              </div>
            ...
            <div className="flex flex-col mb-6">
              ...
              <textarea
                ...
                required
                rows="5"
                className="w-full p-3 bg-white text-black rounded-md text-sm sm:text-base h-32 resize-none focus:outline-none focus:ring-2 focus:ring-[#8eaee0]"
              />
            </div>
